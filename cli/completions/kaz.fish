...
complete -c kaz -n __fish_use_subcommand -a spark   -d 'sparkline: bars, no axes, one row'
complete -c kaz -n __fish_use_subcommand -a describe -d 'summary statistics per column'
complete -c kaz -n __fish_use_subcommand -a table   -d 'the numbers as an aligned table'
complete -c kaz -n __fish_use_subcommand -a caps    -d 'what detection sees for this terminal'
complete -c kaz -n __fish_use_subcommand -a spec    -d 'render a serialized document'
...
complete -c kaz -l binwidth -x -d 'histogram bin width'
complete -c kaz -l horizontal -d 'bar: sideways'
complete -c kaz -l stack -d 'bar: stack value columns'
complete -c kaz -l group -d 'bar: group value columns'
complete -c kaz -l unit -x -d 'value axis unit'
complete -c kaz -l hline -x -d 'horizontal reference line'
complete -c kaz -l vline -x -d 'vertical reference line'
complete -c kaz -l normalize -x -a 'count probability percent density' -d 'histogram heights'
complete -c kaz -l cumulative -d 'accumulate histogram bins left to right'
