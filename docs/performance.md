...
A snapshot from one 2021 MacBook Pro (Apple M1 Pro), single-threaded, end
to end: construct, resolve, reduce, rasterize, encode. Order of magnitude
and which mechanism wins, not a promise for your machine.
