...
| batch transform | `Window`, `kde`, `ecdf`, `roc`, `ewma`, `lttb`, `stack`, `contours`, `bins2`, `BoxStats` | consumes a complete ordered collection and emits another. It may use accumulators inside. That does not make it mergeable |
