...
pub use presets::{
    ...
    TrendOptions, ViolinOptions, bar, box_plot, box_plot_with, contour, contour_with, contourf,
    contourf_with, density, density_with, describe, describe_with, ecdf, ecdf_with, error_bars,
    error_bars_asymmetric, heatmap, heatmap_with, hist, hist_with, hist2d, hist2d_with, line,
    quiver, scatter, sparkline, stairs, stairs_with, table, table_with, trend, trend_with,
